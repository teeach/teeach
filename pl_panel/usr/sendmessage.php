<?
    ...
    foreach ($users as $user) {
        $query = $con->query("INSERT INTO `plearn`.`pl_messages` (`id`, `from_h`, `to_h`, `subject`, `body`, `h`, `date`) VALUES (NULL, '".$sender."', '".$user."', '".$subject."', '".$content."', '".$System->rand_string(20)."', '".date("Y-m-d H:i:s")."')");
    }
?>
